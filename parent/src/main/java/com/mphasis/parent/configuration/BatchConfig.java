...
import com.mphasis.parent.batch.FileLoadProcessor;
...
public class BatchConfig {
    ...
    public BatchConfig(JobRepository jobRepository, PlatformTransactionManager transactionManager, FileLoadRepository fileLoadRepository) {
